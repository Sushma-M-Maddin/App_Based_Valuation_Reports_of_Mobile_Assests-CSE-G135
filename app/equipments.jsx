...
const EquipmentPriceForm = () => {
    ...
    const htmlContent = `
      <html>
        <body style="margin: 40px; font-family: Arial, sans-serif; text-align: center; border: 2px solid #000;">
          ...
          <h1 style="margin-bottom: 20px;">Equipment Price Prediction Report</h1>
          <p><strong>Date:</strong> ${currentDate}</p>
          <hr style="margin-bottom: 20px;"/>
          ${imageBase64 ? `<img src="${imageBase64}" alt="Equipment Image" style="width: 50%; height: auto; margin-bottom: 20px;" />` : ""}
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    if (!values.name.trim()) {
      setErrorMessage("Invalid name. Please enter a valid equipment name.");
      setSubmitting(false);
      return;
    }
      ...
      <View style={styles.container}>
        ...
        >
          {({
            ...
            <View>
              <Text style={styles.heading}>Equipment Price Prediction</Text>
...
export default EquipmentPriceForm;
